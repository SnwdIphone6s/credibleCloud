...
export const constantRoutes = [
  ...
  {
    path: '/CloudBenchMark/computing',
    component: Layout,
    children: [
      {
        path: '',
        component: () => import('@/views/computing'),
        name: 'computing',
        hidden: true,
        meta: { title: 'computing', affix: true }
      }
    ]
  },
  {
    path: '/CloudBenchMark/block-test',
    component: Layout,
    children: [
      {
        path: '',
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/register_s'),
        name: 'register',
        hidden: true,
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/myTask/loadcount'),
        name: 'downloadComputingPower',
        hidden: true,
        meta: { title: 'register', affix: true }
      }
    ]
